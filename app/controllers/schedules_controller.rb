class SchedulesController < ApplicationController
  ...
  def create
    @schedule = Schedule.new
    @schedule.datetime = params[:datetime].to_datetime
    @schedule.place_id = params[:place_id]
  ...
  def schedule_params
    params.require(:schedule).permit(:state, :city_id, :state_id, :place_id, :datetime, :user_id)
  end
end
